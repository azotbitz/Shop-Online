            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h2 className="text-white pt-5">Смартфоны</h2>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="text-white pt-5">Ноутбуки</h2>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="text-white pt-5">Парфюмерия</h2>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="text-white pt-5">Косметика</h2>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="text-white pt-5">Продукты</h2>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-12">
                        <h2 className="text-white pt-5">Аксессуары для дома</h2>
                    </div>
                </div>
