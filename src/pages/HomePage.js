        ...
        <div className="slider slider-blocks">
            <div className="container-fluid container-md container-lg container-xl container-xxl position-relative">
                    ...
                    >
                        <div className="swiper-wrapper d-flex align-items-center">
                        <SwiperSlide>
                            <div className="swiper-slide card--product d-flex justify-content-center align-items-end pb-4 h-350px" style={{background: 'linear-gradient(to right, rgba(0,0,0,.3),rgba(0,0,0,.3)), url("./assets/imgs/freenudesboy.jpg")'}}>
                            Конструктор букетов
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="swiper-slide card--product d-flex justify-content-center align-items-end pb-4 h-350px" style={{background: 'linear-gradient(to right, rgba(0,0,0,.3),rgba(0,0,0,.3)), url("./assets/imgs/speedcar.jpg")'}}>
                            Срочный заказ
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="swiper-slide card--product d-flex justify-content-center align-items-end pb-4 h-350px" style={{background: 'linear-gradient(to right, rgba(0,0,0,.3),rgba(0,0,0,.3)), url("./assets/imgs/constructor.jpg")'}}>
